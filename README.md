...
instructions and the firmware/API target, and
[`rf_analyzer/docs/`](rf_analyzer/docs/) for the scan/analysis architecture and
an example legal bench setup.

> Use only on equipment you own or are explicitly authorized to test, on
> frequencies you are permitted to receive, following the radio regulations for
> your jurisdiction.
